...
public record GiftContractDetailResponse(
        ...
        @JsonProperty("etf_price") Long etfPrice,
        Integer qty,
    ...
    public static GiftContractDetailResponse of(GiftContract contract, List<GiftTransfer> transfers, String etfName, Long etfPrice) {
