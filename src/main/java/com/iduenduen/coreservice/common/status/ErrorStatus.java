...
public enum ErrorStatus implements BaseStatus {
    ...
    CHILDREN_ALLOWANCE_NOT_LINKED("CHILDREN_409_02", HttpStatus.CONFLICT, "아동수당이 연결되어 있지 않습니다."),

    /**
     * Gift
     */
    GIFT_CONTRACT_INVALID_FIELDS("GIFT_400", HttpStatus.BAD_REQUEST, "증여 유형에 맞는 필드를 입력해주세요."),
    GIFT_CONTRACT_ONLY_TODAY("GIFT_400_03", HttpStatus.BAD_REQUEST, "일시금 및 ETF 증여는 오늘 이후 날짜만 가능합니다."),
    ...
    EXECUTION_LINK_INVALID_CHILD_GOAL("EXEC_400_01", HttpStatus.BAD_REQUEST, "child_id와 goal_id는 함께 설정되거나 함께 null이어야 합니다.");
