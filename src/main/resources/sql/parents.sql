...
(
    ...
    `selected_child_id`        BIGINT       NULL COMMENT '앱 마지막 선택 자녀',
    ...
    `monthly_household_income` TINYINT      NULL,
    `parent_economic_activity` TINYINT      NULL,
    `education_level`          TINYINT      NULL COMMENT '목표설정도우미 교육열 1~5',
